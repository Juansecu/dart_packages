...
//
//     final colombiaData = colombiaDataFromJson(jsonString);
...
ColombiaData colombiaDataFromJson(String str) =>
    ColombiaData.fromJson(json.decode(str));

String colombiaDataToJson(ColombiaData data) => json.encode(data.toJson());
...
class ColombiaData {
  ...
  factory ColombiaData.fromJson(Map<String, dynamic> json) => ColombiaData(
        name: json["name"],
